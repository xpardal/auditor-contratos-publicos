...
- Guía de uso, README, metadatos y cabeceras actualizados con el marco correcto: esta aplicación es parte del proyecto de I+D+i *XornalIA: Desarrollo, validación y transferencia de una plataforma integradora de soluciones de inteligencia artificial generativa para medios de comunicación* (PDC2025-166024-I00).
...
- Suite de 57 tests (`pytest`) y CI en GitHub Actions (Python 3.10 y 3.12).

### Notas

- Esta aplicación es parte del proyecto de I+D+i *XornalIA: Desarrollo, validación y transferencia de una plataforma integradora de soluciones de inteligencia artificial generativa para medios de comunicación* (PDC2025-166024-I00).
